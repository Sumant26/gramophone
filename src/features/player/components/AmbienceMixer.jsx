...
export function AmbienceMixer({
  ...
  return (
    <div
      ...
      className="fixed inset-x-4 bottom-20 z-50 mx-auto max-w-lg rounded-3xl border border-cozy-brass/30 bg-cozy-surface p-5 shadow-2xl backdrop-blur-md sm:bottom-24"
      style={{
        background:
